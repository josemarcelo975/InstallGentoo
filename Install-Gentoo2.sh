...
zone=$(dialog --title "World zones" --menu "To set the system clock,please choose the World Zone of your location." 20 35 15 \
Africa "" America "" Antarctica "" Arctic "" Asia "" Atlantic "" Australia "" Brazil "" Canada "" Europe "" Indian "" Mexico "" Pacific "" US "" --stdout)
if [ $zone = Africa ] ;
	then
subzone=$(dialog --title "Cities in Africa" --menu "Now select your nearest city from this list." 20 35 15 \
...
Sao_Tome "" Timbuktu "" Tripoli "" Tunis "" Windhoek "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in America" --menu "Now select your nearest city from this list." 20 35 15 \
...
St_Kitts "" St_Lucia "" St_Thomas "" St_Vincent "" Swift_Current "" Tegucigalpa "" Thule "" Thunder_Bay "" Tijuana "" Toronto "" Tortola "" Vancouver "" Virgin "" Whitehorse "" Winnipeg "" Yakutat "" Yellowknife "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in Antarctica" --menu "Now select your nearest city from this list." 20 35 15 \
Casey "" Davis "" DumontDUrville "" Macquarie "" Mawson "" McMurdo "" Palmer "" Rothera "" South_Pole "" Troll "" Vostok "" --stdout)
elif [ $zone = Arctic ] ;
	then
subzone=$(dialog --title "Cities in Arctic" --menu "Now select your nearest city from this list." 20 35 15 \
Longyearbyen "" --stdout)
elif [ $zone = Asia ] ;
	then
subzone=$(dialog --title "Cities in Asia" --menu "Now select your nearest city from this list." 20 35 15 \
...
Samarkand "" Seoul "" Shanghai "" Singapore "" Srednekolymsk "" Taipei "" Tashkent "" Tbilisi "" Tehran "" Tel_Aviv "" Thimbu "" Thimphu "" Tokyo "" Tomsk "" Ujung_Pandang "" Ulaanbaatar "" Ulan_Bator "" Urumqi "" Ust-Nera "" Vientiane "" Vladivostok "" Yakutsk "" Yangon "" Yekaterinburg "" Yerevan "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in Atlantic" --menu "Now select your nearest city from this list." 20 35 15 \
...
ACT "" Adelaide "" Brisbane "" Broken_Hill "" Canberra "" Currie "" Darwin "" Eucla "" Hobart "" LHI "" Linderman "" Lord_Howe "" Melbourne "" NSW "" North "" Perth "" Queensland "" South "" Sydney "" Tasmania "" Victoria "" West "" Yancowinna "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in Brazil" --menu "Now select your nearest city from this list." 20 35 15 \
Acre "" DeNoronha "" East "" West "" --stdout)
elif [ $zone = Canada ] ;
	then
subzone=$(dialog --title "Cities in Canada" --menu "Now select your nearest city from this list." 20 35 15 \
Atlantic "" Central "" East-Sashkatchewan "" Eastern "" Mountain "" Newfoundland "" Pacific "" Saskatchewan "" Yukon "" --stdout)
elif [ $zone = Europe ] ;
	then
subzone=$(dialog --title "Cities in Europe" --menu "Now select your nearest city from this list." 20 35 15 \
...
Podgorica "" Prague "" Riga "" Rome "" Samara "" San_Marino "" Sarajevo "" Simferopol "" Skopje "" Sofia "" Stockholm "" Tallinn "" Tirane "" Tiraspol "" Ulyanovsk "" Uzhgorod "" Vaduz "" Vatican "" Vienna "" Vilnius "" Volgograd "" Warsaw "" Zagreb "" Zaporozhye "" Zurich "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in Indian" --menu "Now select your nearest city from this list." 20 35 15 \
Antananarivo "" Chagos "" Christmas "" Cocos "" Comoro "" Kerguelen "" Mahe "" Maldives "" Mauritius "" Mayotte "" Reunion "" --stdout)
elif [ $zone = Mexico ] ;
	then
subzone=$(dialog --title "Cities in Mexico" --menu "Now select your nearest city from this list." 20 35 15 \
BajaNorte "" BajaSur "" General "" --stdout)
elif [ $zone = Pacific ] ;
	then
subzone=$(dialog --title "Cities in Pacific" --menu "Now select your nearest city from this list." 20 35 15 \
...
Tongatapu "" Truk "" Wake "" Wallis "" Yap "" --stdout)
	...
	then
subzone=$(dialog --title "Cities in US" --menu "Now select your nearest city from this list." 20 35 15 \
...
echo $locales.UTF-8 UTF-8 >> /etc/locale.gen
locale-gen
...
EOF
kernel=$(dialog --title "Kernel compilation" --menu "Choose the kernel build option" 20 45 15 \
